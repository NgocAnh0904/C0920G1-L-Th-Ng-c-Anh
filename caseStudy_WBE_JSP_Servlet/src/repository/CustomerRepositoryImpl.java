    ...
    public List<Customer> getAllCustomers() {
        ...
        try(Connection connection = getConnection();
            ...
            while (resultSet.next()){
                String idCustomer = "KH-" + resultSet.getString("customer_id");
                ...
                customerList.add(new Customer(idCustomer, customerType
...
//            statement.setString(1,customer.getIdCustomer().substring(3));
    ...
    public boolean updateCustomer(Customer customer) throws SQLException {
        ...
        try(Connection connection = getConnection();
            ...
            statement.setString(1,customer.getCustomerType());
            ...
            statement.setString(9,customer.getIdCustomer().substring(3));
            check = statement.executeUpdate() > 0;
        }
        return check;
    }
    ...
    public Customer selectCustomer(String id) {
        ...
        try(Connection connection = getConnection();
            ...
            while (resultSet.next()){
                ...
                String email = resultSet.getString("customer_email");
                String address = resultSet.getString("customer_address");
                customer = new Customer(idCustomer, customerType, nameCustomer, birthday, gender, idCard,
    ...
    public List<Customer> searchByName(String name) {
        ...
        try (Connection connection = getConnection();
            ...
            while (resultSet.next()){
                ...
                String email = resultSet.getString("customer_email");
                String address = resultSet.getString("customer_address");
                customerList.add(new Customer(idCustomer, customerType, name1, birthday, gender, idCard,
                        phoneNumber, email, address));
            }
        } catch (SQLException e) {
            e.printStackTrace();
