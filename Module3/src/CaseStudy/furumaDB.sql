...
values (id_khach_hang, 1, 'Minh Chien', '1998-11-17', '123321', '0325330421', 'chien@gmail.com', 'Quang Binh'),
(id_khach_hang, 1, 'The Anh', '1993-01-10', '123321', '0325330422', 'the@gmail.com', 'Quang Tri'),
(id_khach_hang, 3, 'Ngoc Anh', '1995-04-09', '123321', '0325330423', 'anh@gmail.com', 'Da Nang'),
(id_khach_hang, 1, 'Dinh Phuc', '1992-01-10', '123321', '0325330424', 'phuc@gmail.com', 'Hue');
...
insert into trinh_do() values (id_trinh_do, 'Trung hoc pho thong');

insert into bo_phan() values (id_bo_phan, 'marketing');
insert into bo_phan() values (id_bo_phan, 'an ninh');
insert into bo_phan() values (id_bo_phan, 'sales');

insert into nhan_vien() 
values 
(id_nhan_vien, 'Tran Van A', '1995-01-10' ,'123456789', '10 trieu', '09128445', 'A@abc.com', 'Quang Nam',1,1,1),
...
(id_nhan_vien, 'Tran Van D', '2000-11-12' ,'123456789', '5 trieu', '09128445', 'A@abc.com', 'Da Nang',1,3,2 ),
(id_nhan_vien, 'Tran Van E', '1995-01-10' ,'123456789', '5 trieu', '09128445', 'A@abc.com', 'Da Nang',2,3,3 );

insert into dich_vu_di_kem() values 
(id_dich_vu_di_kem, 'massage', 1000, 'USD', 'ngon'),
(id_dich_vu_di_kem, 'karaoke', 100, 'USD', 'oke'),
...
(id_hop_dong_chi_tiet,4,3, 30),
(id_hop_dong_chi_tiet,3,1, 50),
(id_hop_dong_chi_tiet,5,4, 30),
...
loai_dich_vu.ten_loai_dich_vu, hop_dong.ngay_lam_hop_dong, hop_dong.ngay_ket_thuc 
from hop_dong
join dich_vu
...
-- task 7
 ...
 -- task 8 trả về kết quả không trùng lặp
	-- cach 1.
...
-- task 13
    select dich_vu_di_kem.id_dich_vu_di_kem, 
    dich_vu_di_kem.ten_dich_vu_di_kem,
    count(hop_dong_chi_tiet.id_dich_vu_di_kem) as count
    from hop_dong_chi_tiet 
    join dich_vu_di_kem 
    on hop_dong_chi_tiet.id_dich_vu_di_kem = dich_vu_di_kem.id_dich_vu_di_kem
    group by hop_dong_chi_tiet.id_dich_vu_di_kem 
    
    having count = (select count(hop_dong_chi_tiet.id_dich_vu_di_kem) as count 
    from hop_dong_chi_tiet
    join dich_vu_di_kem
    on hop_dong_chi_tiet.id_dich_vu_di_kem = dich_vu_di_kem.id_dich_vu_di_kem
    group by hop_dong_chi_tiet.id_dich_vu_di_kem  
  ...
  select dich_vu_di_kem.id_dich_vu_di_kem, 
  dich_vu_di_kem.ten_dich_vu_di_kem,
  count(hop_dong_chi_tiet.id_dich_vu_di_kem) as so_lan
    from khach_hang 
    ...
    trinh_do.trinh_do, bo_phan.ten_bo_phan, nhan_vien.sdt, nhan_vien.dia_chi, 
    ...
    -- sử dụng SET SQL_SAFE_UPDATES để xóa hay update dữ liệu tạm thời, để tránh việc mất dữ liệu 
    delete
	FROM nhan_vien 
    ...
    IN (SELECT hop_dong.id_khach_hang 
    FROM hop_dong WHERE hop_dong.tong_tien>= 1500 and year(hop_dong.ngay_lam_hop_dong) = 2019
	 );
	...
	DELETE 
	  FROM khach_hang 
	  WHERE khach_hang.id_khach_hang 
      in (SELECT hop_dong.id_khach_hang 
	  FROM hop_dong 
